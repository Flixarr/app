<div class="px-3 py-2 bg-gray-900 border rounded-full shadow-2xl cursor-pointer group bg-gradient-to-r" :class="{
    ...
    <div class="flex items-center space-x-4">
        ...
        <button class="block">
            {{-- Close button --}}
            <svg class="ml-4 w-5 h-5 group-hover:text-white text-muted-dark" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
