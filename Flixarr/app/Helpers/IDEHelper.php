...
namespace Illuminate\Support\Facades {
     ...
     */ class Request
    {
         ...
         * @param  mixed        $default
         *
         * @return  mixed|\Symfony\Component\HttpFoundation\InputBag
         *
         * @static
         */
         ...
         *
         * @param  string|null                                            $key
         * @param  array|\Illuminate\Database\Eloquent\Model|string|null  $default
         *
     ...
     */ class Storage
    {
         ...
         * @param  array|\Illuminate\Http\File|\Illuminate\Http\UploadedFile|string|null  $file
         * @param  mixed                                                                  $options
         *
         * @return  false|string
         *
...
namespace Spatie\LaravelIgnition\Facades {
     ...
     */ class Flare
    {
         ...
         * @static
         *
         * @param  mixed  $filterReportsCallable
         */
        ...
        /**
         * @param  array<ArgumentReducer|class-string<ArgumentReducer>>|\Spatie\Backtrace\Arguments\ArgumentReducers|null  $argumentReducers
         *
         * @static
         */
         ...
         * @static
         *
         * @param  mixed  $withStackFrameArguments
         * @param  mixed  $forcePHPIniSetting
         */
        ...
        /**
         * @return  array<int, class-string<FlareMiddleware>|FlareMiddleware>
         *
         * @static
         */
        public static function getMiddleware()
        ...
        /**
         * @param  array<FlareMiddleware>|callable|\Spatie\FlareClient\class-string<FlareMiddleware>|\Spatie\FlareClient\FlareMiddleware\FlareMiddleware  $middleware
         *
...
namespace {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model
    {
         ...
         *
         * @param  \Closure|\Illuminate\Contracts\Database\Query\Expression|\Illuminate\Database\Query\Builder|string|null  $column
         * @param  string                                                                                                   $direction
         *
         * @return  \Illuminate\Database\Query\Builder
         *
